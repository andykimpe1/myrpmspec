...
%{buildroot}/usr/share/info/autoconf.info.gz %{buildroot}/usr/share/info/autoconf2.69.info.gz
...
%preun
if [ "$1" = 0 ]; then
    /sbin/install-info --del %{_infodir}/autoconf2.69.info %{_infodir}/dir || :
fi

%files
%{_bindir}/*
%{_infodir}/autoconf2.69.info*
# don't include standards.info, because it comes from binutils...
%exclude %{_infodir}/standards*
# don't include info's TOP directory
%exclude %{_infodir}/dir
%{_datadir}/autoconf2.69/
# disable until it may cause too much mess in build system
