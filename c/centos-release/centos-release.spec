...
%define full_release_version 6.10

Name:           centos-release
Version:        %{base_release_version}
Release:        10%{?dist}.12.3
Summary:        %{product_family} release file
Group:          System Environment/Base
License:        GPLv2
Obsoletes:      rawhide-release redhat-release-as redhat-release-es redhat-release-ws redhat-release-de comps rpmdb-redhat fedora-release redhat-release oraclelinux-release sl-release
Provides:	redhat-release
Provides:	system-release
Source0:        centos-release-6-10.tar.gz
...
%changelog
* Tue Jun 25 2018 Johnny Hughes <johnny@centos.org> 6-10.el6.centos.12.3
- CentOS 6.10 Released

* Mon Mar 27 2017 Johnny Hughes <johnny@centos.org> 6-9.el6.centos.12.3
- CentOS-6.9 Released
