...
Patch999:  mysql-fix-timebomb-centos.patch
...
# psmisc for fuser called in init script
Requires: sh-utils, psmisc
...
%changelog
* Thu Jan 26 2017 Johnny Hughes <johnny@centos.org> - 5.1.73-8.0.1
- Fix RH Bugzilla #1412805
...
* Tue Jul 23 2013 Honza Horak <hhorak@redhat.com> 5.1.70-1
- Update to MySQL 5.1.70, for various fixes described at
  http://dev.mysql.com/doc/relnotes/mysql/5.1/en/news-5-1-70.html
  Resolves: #990796, #842052
- Fix mysqldump failure against MySQL 5.0.x server due missing tables
  Resolves: #877557
- Add logrotate script
  Resolves: #904061
- Fix init script to not show failed on start even when server started
  Resolves: #884651
