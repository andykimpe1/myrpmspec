...
License: Copyright 1999-2010 the CentOS Project.  All rights reserved.
URL: http://centos.org
...
cp -rp kde-splash/CentOS6/ $RPM_BUILD_ROOT%{_kde4_appsdir}/ksplash/Themes/
pushd $RPM_BUILD_ROOT%{_kde4_appsdir}/ksplash/Themes/CentOS6/1920x1200/
...
cp -rp kde-kdm/CentOS6/ $RPM_BUILD_ROOT/%{_kde4_appsdir}/kdm/themes/
pushd $RPM_BUILD_ROOT/%{_kde4_appsdir}/kdm/themes/CentOS6/
ln -s %{_datadir}/backgrounds/default.png background.png
...
cp -rp kde-plasma/CentOS6/ $RPM_BUILD_ROOT/%{_datadir}/wallpapers
...
%{_kde4_appsdir}/ksplash/Themes/CentOS6/
%{_kde4_appsdir}/kdm/themes/CentOS6/
%{_kde4_datadir}/wallpapers/CentOS6/
