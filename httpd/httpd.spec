...
Patch36: httpd-2.2.15-drain.patch
Patch37: httpd-2.2.15-r1664565.patch
# Bug fixes
...
Patch117: httpd-2.2.x-mod_proxy-balancer_graceful.patch
Patch118: httpd-2.2.15-ssl-resumption-generous.patch
Patch119: httpd-2.2.15-r1375680.patch
Patch121: httpd-2.2.15-ssl-revoked-logging.patch
Patch122: httpd-2.2.15-documentroot.patch
Patch123: httpd-2.2.15-rotatelog-timezone.patch
Patch124: httpd-2.2.15-r1604460.patch
Patch125: httpd-2.2.15-ab-overflow.patch
Patch126: httpd-2.2.15-ab-ipv6.patch
...
Patch134: httpd-2.2.15-sigint.patch
Patch135: httpd-2.2.15-r1610914.patch
Patch136: httpd-2.2.15-ssl-auth-colon.patch
Patch137: httpd-2.2.15-proxy-flushall.patch
Patch138: httpd-2.2.15-r1684462.patch
Patch139: httpd-2.2.15-r1124515.patch
...
Patch148: httpd-2.2.15-r1683112.patch
Patch149: httpd-2.2.15-r1021621.patch
...
Patch218: httpd-2.2.15-CVE-2013-5704.patch
Patch219: httpd-2.2.15-CVE-2015-3183.patch
...
%patch117 -p1 -b .graceful
%patch118 -p1 -b .generous
%patch119 -p1 -b .r1375680
%patch121 -p1 -b .revokedlog
%patch122 -p1 -b .docroot
%patch123 -p1 -b .timezone
%patch124 -p1 -b .r1604460
%patch125 -p1 -b .aboverflow
%patch126 -p1 -b .ipv6
%patch127 -p1 -b .lang
...
%patch134 -p1 -b .sigint
%patch135 -p1 -b .r1610914
%patch136 -p1 -b .colon
%patch137 -p1 -b .flushall
%patch138 -p1 -b .r1684462
%patch139 -p1 -b .r1124515
...
%patch148 -p1 -b .r1683112
%patch149 -p1 -b .r1021621
...
%patch218 -p1 -b .cve5704
%patch219 -p1 -b .cve3183
...
* Tue Jun 20 2017 Luboš Uhliarik <luhliari@redhat.com> - 2.2.15-63
- Related: #1456324 - segfault in ap_proxy_set_scoreboard_lb

* Fri Jun 16 2017 Luboš Uhliarik <luhliari@redhat.com> - 2.2.15-62
- Resolves: #1456324 - segfault in ap_proxy_set_scoreboard_lb

* Tue Jun 13 2017 Luboš Uhliarik <luhliari@redhat.com> - 2.2.15-61
