...
cp $RPM_BUILD_ROOT%{_datadir}/plymouth/themes/glow/{box,bullet,entry}.png $RPM_BUILD_ROOT%{_datadir}/plymouth/themes/rings
cp $RPM_SOURCE_DIR/lock.png $RPM_BUILD_ROOT%{_datadir}/plymouth/themes/rings
...
%changelog
* Tue Mar 21 2017 Johnny Hughes <johnny@centos.org> - 0.8.3-29
- Roll in CentOS Branding

* Thu Nov 03 2016 Ray Strode <rstrode@redhat.com> - 0.8.3-29
- Ignore duplicate console on kernel command line
  Resolves: #1076265

* Thu Jul 31 2014 Ray Strode <rstrode@redhat.com> 0.8.3-28
...
* Mon Jan 31 2011 Ray Strode <rstrode@redhat.com> 0.8.3-21
- Update lock icon dimensions to match dimensions of old
  icon to silence rpmdiff
  Related: #612665

* Mon Jan 31 2011 Ray Strode <rstrode@redhat.com> 0.8.3-20
- Add new lock icon for rings theme
  Resolves #612665

* Tue Jan 25 2011 Ray Strode <rstrode@redhat.com> 0.8.3-19
- Add explicit, versioned dep on core-libs subpackage to various
  parts of the spec file to silence rpmdiff
  Related: #638621

* Tue Jan 25 2011 Ray Strode <rstrode@redhat.com> 0.8.3-18
- Handle underpowered video cards that force multiple monitors
  to use one controller
  Resolves: #625209
- Fix serial console crash
- Resolves: #631924
- Remove plymouth-text-and-details-only obsoletes
  Resolves: #638621
